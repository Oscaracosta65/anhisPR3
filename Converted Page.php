 ...
 * - game_id = 'PR3'
 * - main balls = 5
 * - main number range = 01..35
 * - bonus range = 01..10 (Bonus Ball)
 */
...
if (isset($stateName, $gName) && $stateName !== '' && $gName !== '') {
    ...
    $doc->setMetaData('description', 'Verified draw results, frequency analysis, hot numbers, and recency data for ' . $stateName . ' ' . $gName . '. Analytical insights powered by LottoExpert.net.');
}
...
$rowsBonus = ($nodCurrentBonus === $nodCurrentMain) ? $rowsMain : leFetchRecentDraws($db, (string) $dbCol, $gameId, $nodCurrentBonus);
...
$jsonLdPage = [
    ...
    '@type'       => 'WebPage',
    'name'        => isset($stateName, $gName) ? $stateName . ' ' . $gName . ' Results Intelligence | LottoExpert.net' : 'Results Intelligence | LottoExpert.net',
    'description' => isset($stateName, $gName) ? 'Verified draw results, frequency analysis, hot numbers, and recency data for ' . $stateName . ' ' . $gName . '.' : 'Lottery results intelligence powered by LottoExpert.net.',
    'url'         => $canonicalNoQuery,
    'publisher'   => ['@type' => 'Organization', 'name' => 'LottoExpert.net'],
];
$jsonLdPageStr = json_encode($jsonLdPage, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES);
?>
<style>
:root{
  --skai-blue:#1C66FF;
      ...
      <div class="skai-hero-top">
        ...
        <div class="skai-hero-copy">
          ...
          <div class="skai-hero-actions" aria-label="Primary actions">
            <a class="skai-btn skai-btn--primary" href="/picking-winning-numbers/artificial-intelligence/skai-lottery-prediction?gameId=PR3">
              Open SKAI Analysis
            </a>
            <a class="skai-btn skai-btn--secondary" href="/picking-winning-numbers/artificial-intelligence/ai-powered-predictions?game_id=PR3">
              AI Predictions
            </a>
          ...
          <div class="skai-advanced-links" aria-label="Advanced tools">
            <a class="skai-mini-link" href="/picking-winning-numbers/artificial-intelligence/skip-and-hit-analysis?game_id=PR3">Skip &amp; Hit Analysis</a>
            <a class="skai-mini-link" href="/picking-winning-numbers/artificial-intelligence/markov-chain-monte-carlo-mcmc-analysis?game_id=PR3">MCMC Markov Analysis</a>
            <a class="skai-mini-link" href="/all-lottery-heatmaps?gameId=PR3">Heatmap Analysis</a>
          </div>
        </div>
  ...
  <section id="frequency-deep-dive" class="skai-section" aria-labelledby="frequency-title">
    <div class="skai-section-head">
      <div>
        ...
        <p class="skai-section-sub">
          Move from summary to full reference. The first panel below shows the complete main-number distribution across all values 01&ndash;<?php echo (int) $mainMax; ?>. The second panel shows the complete Bonus Ball distribution across values 01&ndash;<?php echo (int) $bonusMax; ?> for the selected window.
        </p>
      </div>
    </div>
        ...
        <div class="skai-grid">
          <div class="skai-card">
            <div class="skai-card-head skai-card-head--radiant">
              ...
              <span class="skai-card-sub">All values 01&ndash;<?php echo (int) $bonusMax; ?> across the last <?php echo (int) $nodCurrentBonus; ?> drawings</span>
            </div>
            <div class="skai-card-body">
              <div class="skai-chart-shell">
                <div class="skai-chart-frame">
    ...
    <div class="skai-section-body">
      <div class="skai-two-col">
        ...
        <div class="skai-card">
          <div class="skai-card-head skai-card-head--radiant">
            Bonus Ball table
            <span class="skai-card-sub">Exact counts and recency for values 01&ndash;<?php echo (int) $bonusMax; ?></span>
          </div>
      ...
      <div class="skai-tool-grid">
        <article class="skai-tool">
          ...
          <div class="skai-tool-body">
            ...
            <a class="skai-tool-cta" href="/picking-winning-numbers/artificial-intelligence/skai-lottery-prediction?gameId=PR3">Open SKAI Analysis</a>
          </div>
        </article>
        ...
        <article class="skai-tool">
          ...
          <div class="skai-tool-body">
            ...
            <a class="skai-tool-cta" href="/picking-winning-numbers/artificial-intelligence/ai-powered-predictions?game_id=PR3">Open AI Predictions</a>
          </div>
        </article>
        ...
        <article class="skai-tool">
          ...
          <div class="skai-tool-body">
            ...
            <a class="skai-tool-cta" href="/picking-winning-numbers/artificial-intelligence/skip-and-hit-analysis?game_id=PR3">Open Skip &amp; Hit</a>
          </div>
        </article>
      </div>

      <div class="skai-utility-grid">
        <a class="skai-utility-link" href="/picking-winning-numbers/artificial-intelligence/markov-chain-monte-carlo-mcmc-analysis?game_id=PR3">MCMC Markov Analysis</a>
        <a class="skai-utility-link" href="/all-lottery-heatmaps?gameId=PR3">Heatmap Analysis</a>
